...
public class LevelSelectView extends SelectView {
	...
	private JLabel getLblLevel() {
		if (lblLevel == null) {
			lblLevel = DefaultComponentFactory.getInstance().createLabel("Level 10");
	...
	private JLabel getLblLevel_1() {
		if (lblLevel_1 == null) {
			lblLevel_1 = DefaultComponentFactory.getInstance().createLabel("Level 3");
	...
	private JLabel getLblLevel_2() {
		if (lblLevel_2 == null) {
			lblLevel_2 = DefaultComponentFactory.getInstance().createLabel("Level 4");
	...
	private JLabel getLblLevel_3() {
		if (lblLevel_3 == null) {
			lblLevel_3 = DefaultComponentFactory.getInstance().createLabel("Level 5");
	...
	private JLabel getLblLevel_4() {
		if (lblLevel_4 == null) {
			lblLevel_4 = DefaultComponentFactory.getInstance().createLabel("Level 2");
	...
	private JLabel getLblLevel_5() {
		if (lblLevel_5 == null) {
			lblLevel_5 = DefaultComponentFactory.getInstance().createLabel("Level 6");
	...
	private JLabel getLblLevel_6() {
		if (lblLevel_6 == null) {
			lblLevel_6 = DefaultComponentFactory.getInstance().createLabel("Level 11");
	...
	private JLabel getLblLevel_7() {
		if (lblLevel_7 == null) {
			lblLevel_7 = DefaultComponentFactory.getInstance().createLabel("Level 8");
	...
	private JLabel getLblLevel_8() {
		if (lblLevel_8 == null) {
			lblLevel_8 = DefaultComponentFactory.getInstance().createLabel("Level 9");
	...
	private JLabel getLblLevel_9() {
		if (lblLevel_9 == null) {
			lblLevel_9 = DefaultComponentFactory.getInstance().createLabel("Level 12");
	...
	private JLabel getLblLevel_10() {
		if (lblLevel_10 == null) {
			lblLevel_10 = DefaultComponentFactory.getInstance().createLabel("Level 13");
	...
	private JLabel getLblLevel_11() {
		if (lblLevel_11 == null) {
			lblLevel_11 = DefaultComponentFactory.getInstance().createLabel("Level 7");
	...
	private JLabel getLblLevel_12() {
		if (lblLevel_12 == null) {
			lblLevel_12 = DefaultComponentFactory.getInstance().createLabel("Level 14");
	...
	private JLabel getLblLevel_13() {
		if (lblLevel_13 == null) {
			lblLevel_13 = DefaultComponentFactory.getInstance().createLabel("Level 15");
	...
	private JLabel getLblLevel_14() {
		if (lblLevel_14 == null) {
			lblLevel_14 = DefaultComponentFactory.getInstance().createLabel("Level 16");
	...
	private JLabel getLblLevel_15() {
		if (lblLevel_15 == null) {
			lblLevel_15 = DefaultComponentFactory.getInstance().createLabel("Level 1");
	...
	private JLabel getLblElimination() {
		if (lblElimination == null) {
			lblElimination = new JLabel("Elimination");
		}
	...
	private JLabel getLblLightning_1() {
		if (lblLightning_1 == null) {
			lblLightning_1 = new JLabel("Lightning");
		}
	...
	private JLabel getLblElimination_1() {
		if (lblElimination_1 == null) {
			lblElimination_1 = new JLabel("Elimination");
		}
	...
	private JLabel getLblElimination_2() {
		if (lblElimination_2 == null) {
			lblElimination_2 = new JLabel("Elimination");
		}
	...
	private JLabel getLblLightning_2() {
		if (lblLightning_2 == null) {
			lblLightning_2 = new JLabel("Lightning");
		}
	...
	private JLabel getLblRelease_2() {
		if (lblRelease_2 == null) {
			lblRelease_2 = new JLabel("Release");
		}
		return lblRelease_2;
	}
	...
	private JLabel getLblLightnin() {
		if (lblLightnin == null) {
			lblLightnin = new JLabel("Lightning");
		}
		return lblLightnin;
	}
	...
	private JLabel getLblRelease_3() {
		if (lblRelease_3 == null) {
			lblRelease_3 = new JLabel("Release");
		}
		return lblRelease_3;
	}
