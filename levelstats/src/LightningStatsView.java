...
public class LightningStatsView extends StatsView{
	...
	public LightningStatsView(){
		...
		add(timeText, "flowx,cell 0 4");
		timeText.setEditable(false);
		timeText.setBounds(10, 26, 112, 34);
		add(getTimerPanel(), "cell 0 4");
		add(getpanel(),"cell 0 0");
	}
...
//			setLayout(new MigLayout("", "[grow,center][][][][][]", "[39.00,center][70.00][10.00][49.00][27.00][21.00][50.00,bottom]"));
