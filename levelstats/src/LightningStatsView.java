...
public class LightningStatsView extends JPanel {
	...
	private LightningStats lightningStats;
	String score;
	Timer timer;
	...
	public LightningStatsView(LightningStats lightningStats){
		...
		add(getpanel(), "cell 0 0,aligny top");
		{
			...
			add(panel, "cell 0 1,grow");
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(LightningStatsView.class.getResource("/Images/star icon.png")));
...

		{
			...
			add(panel, "cell 0 2,grow");
			{
				...
				lblNewLabel_2.setIcon(new ImageIcon(LightningStatsView.class.getResource("/Images/star icon.png")));
				panel.add(lblNewLabel_2);
			}
			{
				JLabel lblNewLabel_3 = new JLabel("");
				lblNewLabel_3.setIcon(new ImageIcon(LightningStatsView.class.getResource("/Images/star icon.png")));
...

		{
			...
			add(panel, "cell 0 3,grow");
			{
				...
				lblNewLabel_4.setIcon(new ImageIcon(LightningStatsView.class.getResource("/Images/star icon.png")));
				panel.add(lblNewLabel_4);
			}
			{
				JLabel lblNewLabel_5 = new JLabel("");
				lblNewLabel_5.setIcon(new ImageIcon(LightningStatsView.class.getResource("/Images/star icon.png")));
				panel.add(lblNewLabel_5);
			}
			{
				JLabel lblNewLabel_6 = new JLabel("");
				lblNewLabel_6.setIcon(new ImageIcon(LightningStatsView.class.getResource("/Images/star icon.png")));
	...
	public JPanel getpanel_1() {
		...
		//panel_1.setBounds(28, 225, 73, 28);
		{
			...
			int points = lightningStats.getPoints();
			...
			int initialscore = lightningStats.getScore();
			...
			if(lightningStats!= null){
				...
				//			String points = String.valueOf((lightningStats.getScore()));
				//			System.out.println(points);
	...
	private JPanel getpanel_3(){
		...
		//panel_3.setBounds(0, 275, 128, 28);
		{
			...
			if (lightningStats != null){
				String numMovesLeft = String.valueOf((lightningStats));
	...
	private JLabel getlblTimer(){
		JLabel lblPoints = new JLabel("Timer:");
